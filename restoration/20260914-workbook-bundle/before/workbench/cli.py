...
from .workbooks import analyze_workbook
...
def main(argv=None):
    ...
    analyze = sub.add_parser('analyze'); analyze.add_argument('workbook'); analyze.add_argument('--output')
    ...
    try:
        ...
        elif args.command == 'analyze': problem = analyze_workbook(args.workbook)
