...
def main():
 ...
 authority=json.loads((CORE/'CURRENT_PRODUCT_AUTHORITY.json').read_text()); assert authority['authority_release']=='R391'; canonical_ids=set(authority['canonical_executable_suite_ids']); canonical_pairs={}
 ...
 (HERE/'R392_FULL_CANDIDATE_FRONTIER.jsonl').write_text(''.join(json.dumps(r,ensure_ascii=False)+'\n' for r in rows)); (HERE/'R392_FULL_FRESH_ADJUDICATION_QUEUE.jsonl').write_text(''.join(json.dumps(r,ensure_ascii=False)+'\n' for r in fresh))
