...
LAB=HERE.parent
CORE=LAB/'01_V2_CORE'
ROUTING=json.loads((HERE/'R388_FULL_FAILURE_ROUTING.json').read_text())
...
if shadow_root.exists():
    for d in sorted(shadow_root.glob('V2P*')):
        ...
        products.append({'id':pid,'dir':'SHADOW_PRODUCTS/'+d.name,'text':'\n'.join(chunks),'family':'R388_SHADOW_DISTINCT_CANDIDATE','canonical':False,'quarantined':False})
...
(HERE/'R388_FULL_CLUSTER_SCREEN.json').write_text(json.dumps(out,indent=2,ensure_ascii=False))
